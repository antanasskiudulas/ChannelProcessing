...
namespace ChannelProcessing
{
    ...
    {
        [Option('c', "channel", Required = true, HelpText = "Windows path to channel file to be processed")]
        public string channelPath { get; private set; } = string.Empty;

        [Option('p', "parameters", Required = true, HelpText = "Windows path to parameters file to be applied to channels")]
